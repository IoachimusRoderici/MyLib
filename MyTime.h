...
const char *segundos_a_str (double segundos); //devuelve un string con el tiempo en formato xxh xxm x.xs.
const char *time_t_a_str   (time_t segundos); //devuelve un string con el tiempo en formato xxh xxm xs.
const char *reloj_a_str    ();                //devuelve un string con el tiempo actual en el primer formato.
